...
overall_file.close()
overall_file = open('Seq2seq_dataset\\213\\seq2seq_213.csv', 'w')
for item in new_data:
    overall_file.write(item)

train_file = open('Seq2seq_dataset\\213\\seq2seq_213_train.csv', 'w')
test_file = open('Seq2seq_dataset\\213\\seq2seq_213_test.csv', 'w')
...
data = pd.read_csv("seq2seq_213.csv", sep=',')
